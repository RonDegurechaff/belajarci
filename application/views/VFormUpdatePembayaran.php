...
<form action="<?php echo site_url('Welcome/UpdateDataPembayaran'); ?>" method="post">
	<form class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="hidden" name="id_pembayaran" class="form-control" value="<?php echo $detail['id_pembayaran']; ?>">
			</div>
		</div><br>
